...
const CreateGrant = () => {
    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
        ...
        const [workspaceAdminAcc, _w] = await getWorkspaceAdminAccount(new PublicKey(workspacePublicKey), 0, program.programId)

        const grantPublicKey = await program.rpc.createGrant(0, metadataHash, {
            accounts: {
